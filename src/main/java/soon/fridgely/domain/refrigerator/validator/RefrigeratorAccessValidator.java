...
public class RefrigeratorAccessValidator {
     ...
     */
    public void validateMembership(long refrigeratorId, long memberId) {
        boolean isMember = memberRefrigeratorRepository.existsByRefrigeratorIdAndMemberIdAndStatus(refrigeratorId, memberId, EntityStatus.ACTIVE);
        if (!isMember) {
